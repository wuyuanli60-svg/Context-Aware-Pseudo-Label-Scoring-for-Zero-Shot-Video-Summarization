...
def generate_prompt_target_only(video_title: str,
                                ...
                                user_query: str) -> str:
    """
    Prompt for ALL scenes (no local context, 所有场景均无上下文).
...
class SceneScorer:
    ...
    def compute_scenes_score(self, description_file_name: str, user_query: str, video_title: str = ""):
        ...
        print(f"🔍 Found {num_scenes} scenes for scoring (SumMe-adapted rubric, NO CONTEXT)")
...
def solve(args):
    ...
    for video_name in videos:
        ...
        # 5. 计算评分（SumMe-adapted rubric, NO CONTEXT）
        try:
            print("🧮 Computing scene scores (SumMe-adapted rubric, NO CONTEXT)...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Video Scene Scoring Pipeline (SumMe-adapted rubric, NO CONTEXT, GPT-5)")
